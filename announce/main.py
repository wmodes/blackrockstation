...
app.config('CORS_ORIGINS') = domain_list
app.config('CORS_SUPPORTS_CREDENTIALS') = True
# app.config('CORS_ALLOW_HEADERS') = ["Content-Type", "Authorization", "Access-Control-Allow-Credentials", "Access-Control-Allow-Origin"]
